...
# Create AAE
model = models.CAE_l2(batch_data, batch_labels, cont_latent_size, img_size, enc_neurons, enc_filters, dec_neurons, dec_im_shape, dec_filters)
